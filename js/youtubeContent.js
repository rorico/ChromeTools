...
console.log("chrometools youtube injected");
// in case of double inject
// shouldn't happen
if (p) {
    // not logging as this happens every load up
    // sendRequest("log", "extra youtube injection");
} else {
    console.log("chrometools added listeners");
